...
export default function Index() {
    ...
    async function inserir() {
        ...
        let r = await api.alterar(AlterarId, nome, chamada, curso, turma);
    ...
    async function editar(item) {
        ...
        setAlterarId(item.id_matricula);
    }
                ...
                <div class="body-right-box">
                    <div class="new-student-box">
                        ...
                        <div class="text-new-student">
                            ...
                            <div class="text-new-student"> { AlterarId == 0 ? "Novo Aluno" : "Alterando Aluno " + AlterarId }</div>
                        </div>
                        ...
                        <table class ="table-user">
                            ...
                            <tbody>
                                ...
                                {alunos.map((item, i) =>
                                 ...
                                 ? item.nm_aluno.substr(0, 25) + '...' : item.nm_aluno } </td>
